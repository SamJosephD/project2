...
<body>
 <div class="row">
  ...
  <center> <img src="img/avatar.png" class="img img-circle"> </center>
   ...
   <div class="menu">
    <ul>
	<li class="active"> <a href="index.php"><center>Dashboard </center></a> </li>
   ...
   <br>
   <button name="submit" class="btn btn-success" style="padding:10px;
   font-size:17px;float: right;"> Submit </button>
   <button name="drafts" class="btn btn-info" style="padding:10px;
   font-size:17px;float: left;"> Drafts </button>
      </form>
