...
<br>
 ...
 <br><div class="purple1">
 	<span class="purple" > <center> <h3>Categories</h3> </center> </span>
	</div>
	  <div class="cat">
	  <?php
	  ...
	  if($count_cat>0)
	  {
		  ...
		  ?>
		  <a href="index.php"id=<?php echo $id_cat ?>" style="background:pink;" ><?php echo $name_cat ?>  </a>
	  <?php }}
