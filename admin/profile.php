 ...
 <div class="row">
  ...
  <center> <img src="img/avatar.png" class="img img-circle"> </center>
   ...
   <div class="menu">
	...
	<li class="active"> <a href="profile.php"> <center>Profile</center></a> </li>
	</ul>
   </div>
   </div>
   ...
   <br>
   <button name="submit" class="btn btn-success" style="padding:5px; font-size:17px;float: right;"> Update </button>
   </form>
   <?php
